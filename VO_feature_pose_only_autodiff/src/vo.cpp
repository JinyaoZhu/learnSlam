...
//     g2o::OptimizationAlgorithmLevenberg* solver = new g2o::OptimizationAlgorithmLevenberg ( solver_ptr );
    ...
    VertexProjectXYZ2UVPoseOnly* pose = new VertexProjectXYZ2UVPoseOnly();
    pose->setId ( 0 );
//     double se3[6] = {T_c_w_estimated_.log()(3),T_c_w_estimated_.log()(4),T_c_w_estimated_.log()(5),
//       T_c_w_estimated_.log()(0),T_c_w_estimated_.log()(1),T_c_w_estimated_.log()(2)
//     };
//     pose->setEstimate ( Eigen::Matrix<double,6,1>(se3));
